...
- [ ] Literature brain (`literature/`)
- [ ] Proposal (`docs/proposal/`)
- [ ] CI / tooling / config

## Pre-merge checklist
- [ ] `make check` passes locally (lint + typecheck + tests)
- [ ] If a new citation was added → `literature/index.yaml` updated; `literature/papers/<key>.md` written (or stubbed); theme file updated
- [ ] If a proposal section changed → `build_proposal.py` updated and `proposal_second_draft.docx` regenerated
- [ ] If a new gap surfaced → recorded in `literature/gaps.md`
